<template>
  <a-popover trigger="click" placement="left" color="#E8E8E8">
    <template #content>
    ...
    <div class="layer-image">
      <a-button type="primary" shape="circle" block class="h-100" size="large">
        <img
...
export default defineComponent({
  ...
  setup() {
    ...
    //     imagePath: '/src/assets/layer-image/Openstreetmap_logo.svg.png',
    //   },
    //   {
    //     title: 'Google Map',
    //     imagePath: '/src/assets/layer-image/google-map-1200x1200.png',
    //   },
    //   {
    //     title: 'No Basemap',
    ...
    //   {
    //     title: 'Open Street Map',
    //     imagePath: 'assets/Openstreetmap_logo.svg.png',
    //   },
    //   {
    //     title: 'Google Map',
    //     imagePath: 'assets/google-map-1200x1200.png',
    //   },
    //   {
    //     title: 'No Basemap',
    //     imagePath: 'assets/nobasemap.png',
    //   },
    // ];
    ...
    const basemapLayerData = [
      {
        title: 'Open Street Map',
        imagePath: new URL('/src/assets/layer-image/Openstreetmap_logo.svg.png', import.meta.url),
      },
      {
        title: 'Google Map',
        imagePath: new URL('/src/assets/layer-image/google-map-1200x1200.png', import.meta.url),
      },
      {
        title: 'No Basemap',
    ...
    var layerManagerImage = ref(basemapLayerData[0].imagePath);
